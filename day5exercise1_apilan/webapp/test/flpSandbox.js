		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#day5exercise1apilan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day5exercise1apilan-display": {
								"semanticObject": "day5exercise1apilan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day5exercise1apilan",
									"url": sap.ui.require.toUrl("day5exercise1apilan")
								}
							}
						}
					}
