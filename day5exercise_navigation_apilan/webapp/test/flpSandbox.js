		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation",
									"targetURL": "#day5exercisenavigationapilan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"day5exercisenavigationapilan-display": {
								"semanticObject": "day5exercisenavigationapilan",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=day5exercisenavigationapilan",
									"url": sap.ui.require.toUrl("day5exercisenavigationapilan")
								}
							}
						}
					}
